...
const onAppInit = async function(e) {
    const todos = await _dataFetcher.dataFetcher('./static/data/todos.json');
...
},{"../pages/home":"bA5yS","../pages/todolis":"dUQok","../pages/notFound":"52mDr","../pages/delete":"jQgmu","../pages/edit":"94GrN","../pages/add":"jLsQS","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"bA5yS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const todolistPage = function() {
    ...
    function onEditTodo(e) {
        ...
        const todo = _store.getStore().filter((todo1)=>todo1.id === todoID
        );
        cleanUp();
        _routerDefault.default('/edit', todo[0]);
    }
    function onDeleteTodo(e) {
        ...
        cleanUp();
        _routerDefault.default('/delete', todo[0]);
    }
    function onAddTodo(e) {
        cleanUp();
        _routerDefault.default('/add');
    }
    ...
    function render() {
        ...
        ul.innerHTML = '';
        const elements = todoStore.map((emp)=>_todo.todo(emp)
        );
...
},{"../components/cards/todoList":"6lGnB","../components/cards/todo":"9ga70","../redux/store":"fKkA9","../components/ui/header":"uox36","../components/ui/button":"35nla","../routes/router":"3ISf2","../redux/reducers":"hCUDf","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"6lGnB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
const todo = function({ id , category , isComplete , title , endDate  }) {
    ...
    const paraEditelement = _makeElementDefault.default(paraEditTemplate);
    const paraDeleteelement = _makeElementDefault.default(paraDeleteTemplate);
    const element = _makeElementDefault.default(template);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"hCUDf":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const reducers = function(action) {
    ...
    switch(action.type){
        ...
        case "edit":
            ...
            _store.updateStore(editState);
            return "edit an todo";
        case "add":
            const storeold = _store.getStore();
            const addnewState = action.payload;
            const addToStore = [
                ...storeold,
                addnewState
            ];
            _store.updateStore(addToStore);
...
},{"./store":"fKkA9","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"52mDr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
},{"../../utils/makeElement":"ggL9Z","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"jQgmu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
const deletePage = function(props) {
    const div = document.createElement('div');
    const header = _header.headercontent();
    const headingh2 = _levelHeadingDefault.default('h2', 'Delete Task');
    ...
    function onCancelDelete(e) {
        cleanUp();
        _routerDefault.default('/todolist');
    }
    function onDeleteTodo(e) {
        //const todo = getStore().find(todo=>{
        //   return todo.id === props.id
        //})
        const index = _store.getStore().findIndex((todo)=>todo.id === props.id
        );
        const action = {
            type: "delete",
            payload: {
...
},{"../utils/makeElement":"ggL9Z","../components/ui/link":"ipcsc","../components/ui/header":"uox36","../components/ui/button":"35nla","../components/ui/levelHeading":"7w2RS","../redux/reducers":"hCUDf","../routes/router":"3ISf2","../redux/store":"fKkA9","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"94GrN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
const editpage = function(props) {
    const div = document.createElement('div');
    const header = _header.headercontent();
    const headingh2 = _levelHeadingDefault.default('h2', 'Edit Task');
    const cancelbutton = _buttonDefault.default('Cancel', 'cancel-button');
    const editbutton = _buttonDefault.default('Update Task', 'edit-button');
    const buttondiv = document.createElement('div');
    buttondiv.setAttribute('class', 'button-flex');
...
},{"../utils/makeElement":"ggL9Z","../components/ui/header":"uox36","../components/ui/button":"35nla","../components/ui/levelHeading":"7w2RS","../routes/router":"3ISf2","../redux/reducers":"hCUDf","../redux/store":"fKkA9","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"jLsQS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _makeElement = require("../utils/makeElement");
var _makeElementDefault = parcelHelpers.interopDefault(_makeElement);
...
const addpage = function() {
    const div = document.createElement('div');
    const header = _header.headercontent();
    const headingh2 = _levelHeadingDefault.default('h2', 'Add A New Task');
    const cancelbutton = _buttonDefault.default('Cancel', 'cancel-button');
    const addbutton = _buttonDefault.default('Add new Task', 'add-button');
    const buttondiv = document.createElement('div');
    buttondiv.setAttribute('class', 'button-flex');
...
},{"../utils/makeElement":"ggL9Z","../components/ui/header":"uox36","../components/ui/button":"35nla","../components/ui/levelHeading":"7w2RS","../routes/router":"3ISf2","../redux/reducers":"hCUDf","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"eTj5l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
